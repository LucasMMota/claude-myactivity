...
```
MyActivity/
├── new.sh                                 # start a new session from here (auto-generated)
...
| Item | What it is |
|---|---|
| `MyActivity/new.sh` | **Start a new session** from where your sessions live (auto-generated by the hook). Mirror of the repo-root `./new.sh`. |
